                ...
                {activeTab === 'white' && (
                    <div className={`transition-all duration-500 ${isInView ? 'opacity-100' : 'opacity-0'}`}>
                        <div className="bg-black/40 rounded-lg p-8 md:p-10 mb-8 hover:bg-black/50 transition-all">
                            <h3 className="text-2xl font-serif text-accent mb-6 font-light text-center">
                                Summer Formal
                            </h3>

                            <p className="text-foreground/90 text-center mb-8 font-light leading-relaxed">
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mb-8">
                                ...
                                <div className="bg-background/20 rounded-lg p-6 border border-accent/20 hover:border-accent/40 transition-all">
                                    <h4 className="text-xl font-serif text-accent mb-4 font-light">For Women</h4>
                                    <ul className="space-y-2 text-foreground/90 font-light text-sm">
                                ...
                                {/* For Men */}
                                <div className="bg-background/20 rounded-lg p-6 border border-accent/20 hover:border-accent/40 transition-all">
                                    <h4 className="text-xl font-serif text-accent mb-4 font-light">For Men</h4>
                                    <ul className="space-y-2 text-foreground/90 font-light text-sm">
                                        <li className="flex items-start gap-2">
                                            <span className="text-accent mt-1">✦</span>
                    ...
                    <div className={`transition-all duration-500 ${isInView ? 'opacity-100' : 'opacity-0'}`}>
                        <div className="bg-black/40 rounded-lg p-8 md:p-10 hover:bg-black/50 transition-all">
                            ...
                            <div className="bg-background/20 rounded-lg p-6 border border-accent/20 mb-8">
                                <h4 className="text-xl font-serif text-accent mb-4 font-light text-center">Suggested Colors</h4>
                                <div className="flex flex-wrap justify-center gap-4">
                                    {['Ivory', 'Champagne', 'Taupe', 'Teal', 'Emerald', 'Royal Blue', 'Plum', 'Rust', 'Burnt Orange'].map((color) => (
                                        <span
                                            key={color}
                                            className="px-4 py-2 bg-accent/20 text-foreground rounded-full text-sm font-light border border-accent/30"
                                        >
                                            {color}
                                        </span>
                                    ))}
